...
/**
 * CefInstrument Class Doc Comment
 *
 * @category Class
 * @description Security instrument metadata for closed-end fund positions.
 * @package  SnapTrade
 * @implements \ArrayAccess<string, mixed>
 */
class CefInstrument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CefInstrument';
