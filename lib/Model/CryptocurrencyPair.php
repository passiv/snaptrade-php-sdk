...
class CryptocurrencyPair implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets base
     *
     * @param string $base The base currency (e.g., \"BTC\" in BTC/USD). Can be a fiat or crypto code.
     *
     * @return self
     */
     ...
     * Sets quote
     *
     * @param string $quote The quote currency (e.g., \"USD\" in BTC/USD). Can be a fiat or crypto code.
     *
     * @return self
     */
