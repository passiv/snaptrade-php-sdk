 ...
 */
class ManualTradeBalance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManualTradeBalance';
    ...
    */
    ...
    public function setCash($cash)
    {
        ...
        if (is_null($cash)) {
            array_push($this->openAPINullablesSetToNull, 'cash');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cash', $nullablesSetToNull);
            if ($index !== FALSE) {
