...
/**
    ...
    /**
     * Operation getCalculatedTradeImpactById
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCalculatedTradeImpactById'] to see the possible values for this operation
     *
     * @throws \SnapTrade\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation getCalculatedTradeImpactByIdWithHttpInfo
     *
     * Return details of a specific trade before it&#39;s placed
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
        ...
        try {
            ...
            try {
                ...
                if (
                    ...
                    return $this->getCalculatedTradeImpactByIdWithHttpInfo(
                        $portfolio_group_id,
                        $calculated_trade_id,
                        $trade_id,
                        $contentType,
    ...
    /**
     * Operation getCalculatedTradeImpactByIdAsync
     *
     * Return details of a specific trade before it&#39;s placed
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
    ...
    /**
     * Operation getCalculatedTradeImpactByIdAsyncWithHttpInfo
     *
     * Return details of a specific trade before it&#39;s placed
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
    ...
    /**
     * Create request for operation 'getCalculatedTradeImpactById'
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
     * @param  string $calculated_trade_id The ID of calculated trade to get account impact (required)
     * @param  string $trade_id The ID of trade object (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCalculatedTradeImpactByIdRequest($portfolio_group_id, $calculated_trade_id, $trade_id, string $contentType = self::contentTypes['getCalculatedTradeImpactById'][0])
    {
        ...
        $resourcePath = '/portfolioGroups/{portfolioGroupId}/calculatedtrades/{calculatedTradeId}/modify/{tradeId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getCalculatedTradesImpact
     *
     * Return the impact of placing a series of trades on the portfolio
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
     * @param  string $calculated_trade_id The ID of calculated trade to get account impact (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCalculatedTradesImpact'] to see the possible values for this operation
     *
     * @throws \SnapTrade\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation getCalculatedTradesImpactWithHttpInfo
     *
     * Return the impact of placing a series of trades on the portfolio
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
     ...
     * @throws \SnapTrade\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SnapTrade\Model\TradeImpact[], HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            try {
                ...
                if (
                    ...
                    return $this->getCalculatedTradesImpactWithHttpInfo(
                        $portfolio_group_id,
                        $calculated_trade_id,
                        $contentType,
                        $requestOptions->setRetryOAuth(false)
            ...
            switch($statusCode) {
                case 200:
                    if ('\SnapTrade\Model\TradeImpact[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SnapTrade\Model\TradeImpact[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\SnapTrade\Model\TradeImpact[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
    ...
    /**
     * Operation getCalculatedTradesImpactAsync
     *
     * Return the impact of placing a series of trades on the portfolio
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
    ...
    /**
     * Operation getCalculatedTradesImpactAsyncWithHttpInfo
     *
     * Return the impact of placing a series of trades on the portfolio
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
    ...
    /**
     * Create request for operation 'getCalculatedTradesImpact'
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
     * @param  string $calculated_trade_id The ID of calculated trade to get account impact (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCalculatedTradesImpact'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getCalculatedTradesImpactRequest($portfolio_group_id, $calculated_trade_id, string $contentType = self::contentTypes['getCalculatedTradesImpact'][0])
    {
        ...
        $resourcePath = '/portfolioGroups/{portfolioGroupId}/calculatedtrades/{calculatedTradeId}/impact';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation modifyCalculatedTradeById
     *
     ...
     * @param  string $calculated_trade_id The ID of calculated trade to get account impact (required)
     * @param  string $trade_id The ID of trade object (required)
     * @param  \SnapTrade\Model\Trade $trade trade (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['modifyCalculatedTradeById'] to see the possible values for this operation
     *
     * @throws \SnapTrade\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \SnapTrade\Model\Trade
    ...
    /**
     * Operation modifyCalculatedTradeByIdWithHttpInfo
     *
     * Modify units of a trade before it is placed
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
     * @param  string $calculated_trade_id The ID of calculated trade to get account impact (required)
     * @param  string $trade_id The ID of trade object (required)
     * @param  \SnapTrade\Model\Trade $trade (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['modifyCalculatedTradeById'] to see the possible values for this operation
     *
     * @throws \SnapTrade\ApiException on non-2xx response
     * @throws \InvalidArgumentException
        ...
        try {
            ...
            try {
                ...
                if (
                    ...
                    return $this->modifyCalculatedTradeByIdWithHttpInfo(
                        $portfolio_group_id,
                        $calculated_trade_id,
                        $trade_id,
                        $trade,
    ...
    /**
     * Operation modifyCalculatedTradeByIdAsync
     *
     * Modify units of a trade before it is placed
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
    ...
    /**
     * Operation modifyCalculatedTradeByIdAsyncWithHttpInfo
     *
     * Modify units of a trade before it is placed
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
    ...
    /**
     * Create request for operation 'modifyCalculatedTradeById'
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
     * @param  string $calculated_trade_id The ID of calculated trade to get account impact (required)
     * @param  string $trade_id The ID of trade object (required)
    ...
    public function modifyCalculatedTradeByIdRequest($portfolio_group_id, $calculated_trade_id, $trade_id, $trade = SENTINEL_VALUE, string $contentType = self::contentTypes['modifyCalculatedTradeById'][0])
    {
        ...
        if (isset($trade)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($trade));
            } else {
                $httpBody = $trade;
            }
        } elseif (count($formParams) > 0) {
    ...
    /**
     * Operation placeCalculatedTrades
     *
     * Place orders for the CalculatedTrades in series
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
     * @param  string $calculated_trade_id The ID of calculated trade to get account impact (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['placeCalculatedTrades'] to see the possible values for this operation
     *
     * @throws \SnapTrade\ApiException on non-2xx response
     * @throws \InvalidArgumentException
    ...
    /**
     * Operation placeCalculatedTradesWithHttpInfo
     *
     * Place orders for the CalculatedTrades in series
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
     ...
     * @throws \SnapTrade\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \SnapTrade\Model\TradeExecutionStatus[], HTTP status code, HTTP response headers (array of strings)
     */
        ...
        try {
            ...
            try {
                ...
                if (
                    ...
                    return $this->placeCalculatedTradesWithHttpInfo(
                        $portfolio_group_id,
                        $calculated_trade_id,
                        $contentType,
                        $requestOptions->setRetryOAuth(false)
            ...
            switch($statusCode) {
                case 200:
                    if ('\SnapTrade\Model\TradeExecutionStatus[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SnapTrade\Model\TradeExecutionStatus[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\SnapTrade\Model\TradeExecutionStatus[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SnapTrade\Model\TradeExecutionStatus[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation placeCalculatedTradesAsync
     *
     * Place orders for the CalculatedTrades in series
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
    ...
    /**
     * Operation placeCalculatedTradesAsyncWithHttpInfo
     *
     * Place orders for the CalculatedTrades in series
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
    ...
    /**
     * Create request for operation 'placeCalculatedTrades'
     *
     * @param  string $portfolio_group_id The ID of the PortfolioGroup to perform rebalancing calculations (required)
     * @param  string $calculated_trade_id The ID of calculated trade to get account impact (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['placeCalculatedTrades'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function placeCalculatedTradesRequest($portfolio_group_id, $calculated_trade_id, string $contentType = self::contentTypes['placeCalculatedTrades'][0])
    {
        ...
        $resourcePath = '/portfolioGroups/{portfolioGroupId}/calculatedtrades/{calculatedTradeId}/placeOrders';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
