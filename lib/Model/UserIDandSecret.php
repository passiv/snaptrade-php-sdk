 ...
 */
class UserIDandSecret implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserIDandSecret';
    ...
    */
     ...
     * Sets user_secret
     *
     * @param string|null $user_secret SnapTrade User Secret randomly generated by SnapTrade. This is privileged information and if compromised, should be rotated via the [rotate user secret endpoint](/reference/Authentication/Authentication_resetSnapTradeUserSecret)
     *
     * @return self
     */
    public function setUserSecret($user_secret)
    {
        ...
        if (is_null($user_secret)) {
            throw new \InvalidArgumentException('non-nullable user_secret cannot be null');
        }
