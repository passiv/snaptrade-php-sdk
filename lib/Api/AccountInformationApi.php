...
/**
     ...
     */
    public function getUserAccountRecentOrdersWithHttpInfo($user_id, $user_secret, $account_id, string $contentType = self::contentTypes['getUserAccountRecentOrders'][0], \SnapTrade\RequestOptions $requestOptions = new \SnapTrade\RequestOptions())
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getUserAccountRecentOrdersAsyncWithHttpInfo($user_id, $user_secret, $account_id, string $contentType = self::contentTypes['getUserAccountRecentOrders'][0], \SnapTrade\RequestOptions $requestOptions = new \SnapTrade\RequestOptions())
    {
        $returnType = '\SnapTrade\Model\RecentOrdersResponse';
        ["request" => $request, "serializedBody" => $serializedBody] = $this->getUserAccountRecentOrdersRequest($user_id, $user_secret, $account_id, $contentType);
