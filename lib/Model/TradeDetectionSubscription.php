...
/**
 * TradeDetectionSubscription Class Doc Comment
 *
 * @category Class
 ...
 */
class TradeDetectionSubscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TradeDetectionSubscription';
    ...
    */
     ...
     * Sets cost
     *
     * @param string $cost Monthly subscription cost as a decimal string.
     *
     * @return self
     */
     ...
     *
     * @param int $check_interval_seconds How often the subscribed account is checked for new trades.
     *
     * @return self
     */
