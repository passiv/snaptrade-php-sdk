 ...
 */
class AccountValueHistoryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountValueHistoryItem';
    ...
    */
     ...
     * Sets date
     *
     * @param \DateTime|null $date The date of the estimated account value
     *
     * @return self
     */
     ...
     * Sets total_value
     *
     * @param string|null $total_value Estimate of the total market value of this account (includes cash, equity, fixed income, etc) at the given date.
     *
     * @return self
     */
